    ...
    >
      ...
      <div>
        ...
        <li className={styles.targetMenu}>
          <a
            onClick={(e) =>
              dispatch(getAndSetByCategoryFoodAction(e.target.innerText))
            }
          >
            Combo Meals
          </a>
      ...
      <div>
        ...
        <li className={styles.targetMenu}>
          <a onClick={() => dispatch(getAndSetFoodActionByRating(5))}>
            <span
              className={`fa fa-star ${styles.starIcon} ${styles.checked}`}
            ></span>
            <span
              className={`fa fa-star ${styles.starIcon} ${styles.checked}`}
            ></span>
        ...
        <li className={styles.targetMenu}>
          <a onClick={() => dispatch(getAndSetFoodActionByRating(4))}>
            ...
            <span
              className={`fa fa-star ${styles.starIcon} ${styles.checked}`}
            ></span>
            <span className={`fa fa-star ${styles.starIcon}`}></span>4 Star
          </a>
        </li>
        <li className={styles.targetMenu}>
          <a onClick={() => dispatch(getAndSetFoodActionByRating(3))}>
            ...
            <span className={`fa fa-star ${styles.starIcon}`}></span>3 Star
          </a>
        </li>
        <li className={styles.targetMenu}>
          <a onClick={() => dispatch(getAndSetFoodActionByRating(2))}>
            ...
            <span className={`fa fa-star ${styles.starIcon}`}></span>
            <span className={`fa fa-star ${styles.starIcon}`}></span>
            <span className={`fa fa-star ${styles.starIcon}`}></span>2 Star
          </a>
        </li>
        <li className={styles.targetMenu}>
          <a onClick={() => dispatch(getAndSetFoodActionByRating(1))}>
            ...
            <span className={`fa fa-star ${styles.starIcon}`}></span>
            <span className={`fa fa-star ${styles.starIcon}`}></span>
            <span className={`fa fa-star ${styles.starIcon}`}></span>1 Star
          </a>
        </li>
      </div>
    </ul>
