...
export const getByRatingFood = async (rating) =>
    ...
    await axios.get(`https://peaceful-citadel-48843.herokuapp.com/food/rating?rating=${ rating }`);
...
export const getByPriceFilter = async (priceFrom, priceTo) =>
    await axios.get(`https://peaceful-citadel-48843.herokuapp.com/food/filter/byprice?priceFrom=${ priceFrom }&priceTo=${ priceTo }`);

export const getBySearch = async (params) =>
    await axios.get(`https://peaceful-citadel-48843.herokuapp.com/food/search/product/byuser?params=${ params }`)

export const getPopularProduct = async () =>
    await axios.get("https://peaceful-citadel-48843.herokuapp.com/food/popular/items");

export const getRecommendedProduct = async () =>
    await axios.get("https://peaceful-citadel-48843.herokuapp.com/food/recommended/items");
