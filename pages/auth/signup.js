      ...
      {successSignUs
        ? (
          <div className={`card ${ styles.cardSuccessSignup }`}>
            <h1 className="fs-2"><i className="fas text-success fa-check-circle"></i> Successfully Signed Up!</h1>
            <h1 className="fs-5 ps-4 pt-3 ">Please <span className="fw-bold text-color"><Link href="/auth/signin">Login</Link></span> to Continue.</h1>
          </div>
        )
        : (
